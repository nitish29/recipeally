...
class Recipes(models.Model):
    ...
    recipe_type = models.IntegerField(
        default=0, choices=RECIPE_TYPE, null=True)
...
# TODO : Make a signal function = post_save(), that saves the about data
# in the user profile table once a new user registers / or an exisitng
# user updates info
